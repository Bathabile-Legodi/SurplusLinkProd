...
for (const file of files) {
  ...
  // We can either remove the whole beforeLoad if it only contains requireRole, or just requireRole.
  // Easiest is to remove `beforeLoad: () => requireRole("ngo"),` and `import { requireRole } from "@/lib/auth-guard";`
